...
public static WebDriver oBrowser=null;
	...
	static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("customerNameField")).sendKeys("DemoCustomer");
			Thread.sleep(1000);
	...
	static void createProject()
	{
		try
		{
			...
			Thread.sleep(1000);			
			oBrowser.findElement(objectmap.getLocator("projectNameField")).sendKeys("DemoProject");
			Thread.sleep(1000);
	...
	static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("txtAreaProject")).sendKeys("It is Finanace domain project");
			Thread.sleep(1000);			
			oBrowser.findElement(objectmap.getLocator("closeButtonProject")).click();
			Thread.sleep(1000);			
		}catch(Exception e)
		{
			e.printStackTrace();
